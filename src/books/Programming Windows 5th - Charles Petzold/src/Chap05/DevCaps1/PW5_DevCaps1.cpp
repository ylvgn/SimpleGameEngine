	...
	public:
		...
		DM() {
			static Item dm[] = {
				...
				SGE_DEFINEMARK__ITEM(HORZSIZE,      L"Width in millimeters"),		// logical width  = 25.4 * horizontal resolution / logical pixel x
				SGE_DEFINEMARK__ITEM(VERTSIZE,      L"Height in millimeters"),		// logical height = 25.4 * vertical resolution / logical pixel y
				// pixel dimension
				SGE_DEFINEMARK__ITEM(HORZRES,       L"Width in pixels"),			// horizontal resolution in pixels, same as ::GetSystemMetrics(SM_CXSCREEN)
				SGE_DEFINEMARK__ITEM(VERTRES,       L"Height in raster lines"),		// vertical resolution in pixels, same as ::GetSystemMetrics(SM_CYSCREEN)
				...
				SGE_DEFINEMARK__ITEM(BITSPIXEL,     L"Color bits per pixel"),		// 32 bit color nowadays (r8g8b8a8)
				...
				SGE_DEFINEMARK__ITEM(LOGPIXELSX,    L"Horizontal dots per inch"),	// logical pixel x
